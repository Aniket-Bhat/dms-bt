...
PluginSettings {
    ...
    StyledRect {
        ...
        Column {
            ...
            StringSetting {
                ...
                placeholder: "bt"
                defaultValue: "bt"
                onValueChanged: root.saveValue("trigger", value)
            }
        }
    }
    ...
    StyledRect {
        ...
        Column {
            ...
            SliderSetting {
                ...
                label: "Scan Duration"
                description: "How long to scan for nearby devices"
                defaultValue: 5
                minimum: 3
                maximum: 30
                unit: "sec"
                onValueChanged: root.saveValue("countdownDuration", value)
            }

            ToggleSetting {
                settingKey: "showDiscovered"
                label: "Show Discovered Devices"
                description: "Show nearby unpaired devices found during a scan"
                defaultValue: true
                onValueChanged: root.saveValue("showDiscovered", value)
            }
        }
    }
    ...
    StyledRect {
        width: parent.width
        height: btColumn.implicitHeight + Theme.spacingL * 2
        radius: Theme.cornerRadius
        color: Theme.surfaceContainerHigh
        ...
        Column {
            ...
            ToggleSetting {
                settingKey: "autoEnableBluetooth"
                label: "Auto-enable Bluetooth"
                description: "Automatically power on Bluetooth when scanning or connecting"
                defaultValue: true
                onValueChanged: root.saveValue("autoEnableBluetooth", value)
            }
        }
    }
